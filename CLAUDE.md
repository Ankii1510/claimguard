...
```bash
# Linting
genvm-lint check contracts/claim_guard.py    # Lint a contract
...
- Contract interactions: `frontend/lib/contracts/ClaimGuard.ts`
- React hooks: `frontend/lib/hooks/useClaimGuard.ts`
