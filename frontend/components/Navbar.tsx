...
import { useClaims } from "@/lib/hooks/useClaimGuard";
...
export function Navbar() {
  ...
  const verifiedClaims = claims?.filter((c) => c.has_resolved).length || 0;
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg md:text-xl font-bold ml-2">ClaimGuard</span>
              </div>
